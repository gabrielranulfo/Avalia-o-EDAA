...
with open("./teste/arranjo_100_mil.txt", "w") as f:
...
with open("./teste/arranjo_400_mil.txt", "w") as f:
...
with open("./teste/arranjo_500_mil.txt", "w") as f:
...
with open("./teste/arranjo_600_mil.txt", "w") as f:
...
with open("./teste/arranjo_700_mil.txt", "w") as f:
...
with open("./teste/arranjo_800_mil.txt", "w") as f:
...
with open("./teste/arranjo_900_mil.txt", "w") as f:
...
with open("./teste/arranjo_1_milhao.txt", "w") as f:
