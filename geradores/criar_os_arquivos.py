...
with open("./arquivos/arranjo_100_mil.txt", "w") as f:
...
with open("./arquivos/arranjo_200_mil.txt", "w") as f:
    for number in arranjo_200k:
        f.write(str(number) + "\n")

arranjo_300k = random.sample(range(1, range_dos_numeros), 300_000)

with open("./arquivos/arranjo_300_mil.txt", "w") as f:
...
with open("./arquivos/arranjo_400_mil.txt", "w") as f:
...
with open("./arquivos/arranjo_500_mil.txt", "w") as f:
...
with open("./arquivos/arranjo_600_mil.txt", "w") as f:
...
with open("./arquivos/arranjo_700_mil.txt", "w") as f:
...
with open("./arquivos/arranjo_800_mil.txt", "w") as f:
...
with open("./arquivos/arranjo_900_mil.txt", "w") as f:
...
with open("./arquivos/arranjo_1_milhao.txt", "w") as f:
